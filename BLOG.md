## January-7
---
- Found some recent books on AI. I've read some great AI books in the past, including Life 3.0, Superintelligence. Found a couple that I haven't read yet that have some pretty positive reviews on Amazon. 2084 - Artificial Intelligence and the Future of Humanity-Zondervan (2020) by John C. Lennox is one that I'll start picking up. Also found a couple of newer technical reference books that get into Transformers and other algorithms.
